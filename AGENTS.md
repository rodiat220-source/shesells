...
> 黑客松 2026 · 3天交付 · 前后端全栈规范

---

## 1. 核心原则（Karpathy 式编码准则）

### 1.1 Think Before Coding（先思考后编码）

- 不要自行做沉默假设，遇到需求歧义必须主动澄清
- 列明所有隐含假设，同时给出不同实现方案的权衡取舍
- 优先推荐最简可行方案
- 困惑时立刻停下来确认，不要硬写代码
...
### 1.3 Surgical Changes（外科手术式精准修改）

- 只改动任务明确要求的代码片段，不触碰任何无关代码
- 不擅自重构、优化正常运行的逻辑
- 严格遵循项目原有代码的命名和风格规范
- 不随意删除自己不理解的代码
